...
const PhilosophyDetailScreen: React.FC = () => {
  ...
  const { conceptId } = (route.params as any) || { conceptId: 'unknown' };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>Philosophy Details</Text>
        </View>
      ...
      <ScrollView style={styles.scrollView}>
        <LinearGradient
          colors={DharmaDesignSystem.colors.gradients.culturalBlend}
          style={styles.heroSection}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
        >
          <Text style={styles.title}>Philosophy Details</Text>
          <Text style={styles.subtitle}>Concept ID: {conceptId}</Text>
        </LinearGradient>

        <View style={styles.contentSection}>
          <Text style={styles.sectionTitle}>Coming Soon</Text>
          <Text style={styles.placeholderText}>
            Deep philosophical teachings and concepts will be available here.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
