    ...
    sections: [
      {
        ...
        storyText: 'Every tradition faces the same problem: how do you keep a teaching alive across generations without freezing it or losing it? Most religions solved it with a center — a church, a council, a chair somewhere with the final word. Hinduism solved it with lineages: sampradayas, living chains of teacher and student, each "handing over" (the word\'s literal meaning) a complete way of approaching the divine. No lineage could silence another; each rose or fell on the depth of its saints and the loyalty of its households. The result, after three thousand years, is not chaos but an ecosystem — great streams flowing side by side toward the same ocean.',
        teachingText: 'Hold this frame and the tradition\'s bewildering variety becomes legible. When you meet a Hindu practice that looks nothing like your family\'s, you are not seeing error or dilution. You are seeing another stream — older than most countries, carried by unbroken handover, and headed the same direction as yours.',
      ...
      },
      {
        ...
        storyText: 'The largest stream approaches the ultimate as Vishnu — the sustainer who refuses to stay remote. Vaishnavism is built on the avatar principle: when the world tilts, the divine descends into it, as Rama, as Krishna, walking, suffering, delighting, near. Its great text is the Bhagavata Purana, its method is bhakti — love as a spiritual technology — and its emotional register runs from the majesty of Rama\'s court to the butter-thief mischief of the child Krishna. If your family\'s year peaks at Janmashtami or Ram Navami, if the harmonium and the kirtan feel like home, you have drunk from this stream.',
        teachingText: 'Vaishnavism\'s wager is that love is the strongest solvent of ego — stronger than austerity, stronger than analysis. Where other paths climb toward the divine, the Vaishnava lets the divine come close enough to adore. Its gift to the whole tradition is warmth: the insistence that the absolute has a face that smiles back.',
      ...
      },
      {
        ...
        storyText: 'The second great stream approaches the ultimate as Shiva — the god who fits in no palace. Shaivism holds together what looks like contradiction: the motionless ascetic on Kailash and Nataraja, the cosmic dancer whose steps create and dissolve worlds; the householder with Parvati and the wanderer of cremation grounds. Its ancient theological root is the Shvetashvatara Upanishad, which names Rudra-Shiva as the one God; its practices run from the austere (vibhuti, vows, silence) to the ecstatic. If your family keeps Maha Shivratri through the night, or your altar holds a linga — the formless marker of the formless — this is your stream.',
        teachingText: 'Shaivism\'s wager is that the divine is found at the edges — of comfort, of form, of the self. It gave the tradition its yoga of transformation: nothing, not even destruction, is outside God. Its gift is fearlessness: a god who sits calmly in the cremation ground has nothing left to threaten him with.',
      ...
      },
      {
        ...
        storyText: 'The third stream makes the boldest claim of all: ultimate reality is Shakti — power, energy, the force that makes everything go — and Shakti is the Goddess. In Shaktism, Durga, Kali, Lakshmi, and Saraswati are not consorts orbiting male gods; they are the supreme, and the male gods act only by the power she lends. Its charter text is the Devi Mahatmya, in which the gods, defeated, pool their energies and the Goddess emerges to do what none of them could. Bengal\'s Durga Puja, the year\'s twin Navratris, the whispered power of the word "Maa" — all flow from this stream.',
        teachingText: 'Shaktism\'s wager is that the divine is not beyond the world but IS the world\'s aliveness — and therefore fiercely, maternally near. Its gift to the tradition is the theology every child already knows: the first face of unconditional power most humans meet is a mother\'s.',
      ...
      },
      {
        ...
        storyText: 'The fourth stream, associated with the great reformer Shankara, refuses to choose. Smarta practice sets five (sometimes six) deities on one altar — Vishnu, Shiva, Devi, Ganesha, Surya — and worships the one Brahman through whichever face the worshipper loves: the ishta-devata principle made liturgy. Beneath all four streams run the darshanas, the six classical schools of philosophy. Two remain giants: Vedanta, the inquiry into Brahman and Atman that Shankara sharpened into Advaita (non-dualism), and Yoga, Patanjali\'s discipline of stilling the mind. The streams tell you whom to love; the schools examine what loving them means.',
        teachingText: 'Smartism is the tradition auditing itself: if Truth is one and the wise call it by many names, then the names must be interchangeable at the altar. And the schools are the tradition thinking: Hinduism never separated devotion from philosophy — its greatest philosophers wrote hymns, and its greatest hymns argue metaphysics.',
      ...
      },
      {
        ...
        storyText: 'Now look homeward. Which deity anchored your grandparents\' altar? Which festival emptied the kitchen into a week of cooking? Whose stories were told when the power went out? The answers locate your family in this map — Vaishnava-leaning, Shaiva-leaning, Shakta-leaning, or (most common of all) a blend the streams themselves would smile at. There is no purity test. The blending is not confusion; it is what three thousand years of neighboring streams naturally do.',
        sectionHeader: 'The living part',
        teachingText: 'This is one common map; ask your family how they walk it. Ask which stream their parents drank from, and their parents before. The answers you gather are not trivia — they are the living part of the tradition, the handover happening in real time, with you as the next pair of hands.',
    ...
    sections: [
      {
        ...
        storyText: 'Somewhere along the way, "maya" got translated as "the world is an illusion" and a caricature was born: Hindus supposedly believe nothing is real, so nothing matters. The tradition claims almost the opposite. Maya does not say the world is absent; it says the world is misread. The classic image, sharpened by Shankara\'s school, is exact: a traveler at dusk leaps back from a snake on the path. A lamp is brought — it is a rope. The rope was there all along, fully real. The snake was never there at all. And yet the traveler\'s terror was real, the racing heart was real, the leap was real. Illusion, in this tradition, means real experience built on a misreading of something real.',
        teachingText: 'Get this distinction and maya stops being mystical and becomes diagnostic. The question it teaches you to ask — of your fears, your feeds, your certainties about other people — is not "is this real?" but "is this the rope, or my snake?" The two feel identical from inside. That is the whole problem, and the beginning of its solution.',
      ...
      },
      {
        ...
        storyText: 'If maya is a misreading, what is the rope — the reality being misread? The Upanishads\' answer: oneness. There is one reality, Brahman, and maya is the power by which it appears as many separate things — and, most consequentially, as many separate selves. The word\'s own root says it: "ma," to measure. Maya is the measuring-out of the immeasurable, the drawing of boundaries on the boundless. The boundaries are useful — you cannot pour tea without a cup — but the tradition\'s claim is that we forget they are drawn, and then defend them with our lives.',
        sectionHeader: 'The costliest boundary',
        teachingText: 'The misreading that costs the most is the one at the center: the absolute conviction that you end at your skin, and everyone else begins as a rival. Every scarcity panic, every envy, every "us and them" runs on that reading. The tradition does not ask you to erase the boundary — it asks you to remember, at least sometimes, who drew it.',
      ...
      },
      {
        ...
        storyText: 'The Gita\'s one-verse treatment of maya repays slow reading. First: maya is divine — mama maya, "MY maya," Krishna says. It is not a demon\'s trick or a design flaw; the veiling is part of the design, the same power that makes a play possible by hiding the stage machinery. Second: it is guna-mayi, woven of the three gunas — the misreadings run on your own moods and energies, which is why the world looks like a threat on a tamasic day and a market on a rajasic one. Third: duratyaya, genuinely hard to cross. The tradition does not pretend clear seeing is easy. And fourth, the crossing: those who take refuge cross over.',
        teachingText: 'Refuge, inquiry, practice — the streams disagree on emphasis and agree on the point: you do not think your way out of a misreading with the same mind that is doing the misreading. You need a lamp from outside the dusk — a teacher, a practice, a grace. The humility to reach for one is the first step across.',
      ...
      },
      {
        ...
        storyText: 'The rope-and-snake needed dim light; the misreading happens at dusk, not noon. Now consider that some of the brightest engineering talent of our age works on keeping you at dusk: feeds that surface the most snake-like reading of every stranger, filters that make ordinary faces look inadequate, urgency signals attached to the trivial. The tradition analyzed maya as a cosmic condition; we have industrialized it. Every doomscroll is a walk down a path of ropes, at engineered dusk, with someone profiting from each leap.',
        sectionHeader: 'The counter-practice',
        teachingText: 'Which makes the old counter-practices strangely current. Bring the lamp: verify before reacting. Notice the light: tired, hungry, anxious minds breed snakes. And guard the dusk hours — the tradition\'s instinct that dawn and dusk are for practice, not consumption, reads today like operational security for the mind.',
    ...
    sections: [
      {
        ...
        storyText: 'Every tradition has a center of gravity. Buddhism has dependent origination; the Abrahamic faiths have the covenant between God and humanity. Hinduism\'s center is an identity claim: Brahman — the one reality the Rig Veda said the wise call by many names — and Atman — the Self you refer to every time you say "I" — are the same. Not similar. Not connected. The same, the way the space in a jar and the space in the room were never actually two spaces. Take this wall out and the house falls: karma becomes bookkeeping, moksha becomes a destination, the gods become a committee. Put it in and everything else in the tradition becomes either a consequence of the claim or a method for verifying it.',
        teachingText: 'Notice what kind of claim it is: not ethical advice, not a story, but a statement about what you are — checkable, the Upanishads insist, from the inside. The rest of this course is the tradition\'s three great verification methods: an experiment, a negation, and four sentences.',
      ...
      },
      {
        ...
        storyText: 'Uddalaka\'s son Svetaketu came home from twelve years of Vedic study visibly proud. His father asked whether he had learned "that by which the unheard becomes heard, the unthought thought." He had not. So Uddalaka ran the most famous experiment in the Upanishads: put this lump of salt in water tonight. In the morning: bring me the salt. Svetaketu reaches into the water — nothing to grasp. The salt is gone. Taste from the top, says the father. Salt. From the middle. Salt. From the bottom. Salt. The salt was not gone; it had become invisible by becoming pervasive. Just so, says Uddalaka, that subtle essence pervades everything — and tat tvam asi, that is what you are.',
        sectionHeader: 'Why you cannot find your Self',
        teachingText: 'The experiment answers the modern seeker\'s complaint precisely: "I looked within and found no Self — just thoughts and sensations." Of course. Svetaketu\'s hand found no salt either. What pervades cannot be grasped as one object among others; it is found by a different faculty — taste, not sight; being, not introspection. You will never find the Self the way you find your keys. You are how the water tastes.',
      ...
      },
      {
        ...
        storyText: 'The Brihadaranyaka Upanishad offers the second method, two words long: neti neti — not this, not this. Whatever you can observe, you are not. The body? You watch it age — observable, so not this. Emotions? They arrive and leave while you remain to report them — not this. Thoughts? You just watched one — not this. Even the sense of being "me," the ego itself, can be caught in the act and examined — not this. The method never says what the Self is; it strips away everything the Self is mistaken for, the way a sculptor finds the figure by removing stone.',
        teachingText: 'Run it on the inner critic and feel its practical teeth: the voice narrating your inadequacy is audible to you — an object in your awareness, like traffic noise. Whatever hears it is what you are. The tradition\'s boldest move is to claim this remainder — the unwatchable watcher — is Brahman itself. But even before that claim, the method alone is liberating: you are not anything you can observe, and you can observe almost everything you currently call "me."',
      ...
      },
      {
        ...
        storyText: 'The tradition distilled the claim into four "great sayings," one from each Veda, and it is worth seeing that they are one sentence with the pronoun rotated. Prajnanam Brahma — consciousness is Brahman (the impersonal statement). Tat tvam asi — you are That (the teacher\'s statement, to a student). Aham Brahmasmi — I am Brahman (the student\'s discovery, in the first person). Ayam Atma Brahma — this Self is Brahman (the sage\'s confirmation). A curriculum in four lines: what is stated impersonally must be told to you, then found by you, then lived.',
        sectionHeader: 'What changes if it is true',
        teachingText: 'Suppose it, for one day, as a working hypothesis. Then the stranger who cuts you off in traffic is the salt in the same water. Then your death is a wave subsiding, not the ocean drying. Then compassion is not a virtue you strain toward but simple accuracy. The Upanishads do not ask for belief. They ask for the experiment — twelve years, or fifteen minutes tonight: what, when everything observable has been set aside, remains doing the observing?',
    ...
    sections: [
      {
        ...
        storyText: 'The faculties of the body once argued over who was supreme — speech, sight, hearing, mind, breath, each claiming the throne. They took the dispute to the creator, who gave the only empirical answer in the history of such quarrels: the one whose departure ruins the body is chief. So they left, one at a time, a year each. Speech left; the body lived on, mute but alive. Sight left; blind, but alive. Hearing left; deaf, alive. Mind left; mindless as an infant — alive. Then Prana, the breath, merely stirred to go — and the Upanishad gives it the tradition\'s most vivid simile: as a great horse tearing up its tether-pegs, breath rising tore every faculty loose at once. Remain, they said, hurriedly. You are chief.',
        teachingText: 'The parable is a ranking algorithm you can use on your own life: order your dependencies not by how loudly they claim importance but by what actually collapses when each is subtracted. The tradition ran the algorithm on the body and found breath. Run it on your days — sleep, attention, relationships, phone — and see what is genuinely chief, then tend that first.',
      ...
      },
      {
        ...
        storyText: 'Of everything your body does to keep you alive, almost all of it runs locked away from your will: you cannot decide your heartbeat, instruct your digestion, or negotiate with your immune system. Breath is the great exception — it runs perfectly on automatic, and yet the moment you attend to it, it is yours to slow, deepen, hold, release. It is the one vital process with a handle on both sides of the door: autonomic and voluntary. The tradition noticed this anomaly thousands of years ago and drew the engineering conclusion — if mind and body meet anywhere, they meet here, and whoever governs the meeting place can influence both sides.',
        sectionHeader: 'Where prana goes, mind follows',
        teachingText: 'Hence the tradition\'s working axiom: breath and mind ride together. Agitate one and the other bolts; settle one and the other settles. You have verified this backwards all your life — fear shortens breath, grief makes it ragged. Pranayama simply runs the causation forward on purpose: lengthen the exhale and the panic, finding its vehicle slowing, dismounts.',
      ...
      },
      {
        ...
        storyText: 'The Gita lists among its sacrifices "the offering of prana into apana and apana into prana" — the in-breath and out-breath poured into each other, breath itself made the ritual. From that seed grew pranayama, the yogic science of breath regulation: extension of the exhale, balanced counts, retention introduced gradually and with a teacher. The tradition treats it with respect bordering on caution — this is a real intervention in a real system, not a wellness garnish. Twenty-five centuries later, cardiologists measure heart-rate variability, special forces teach box breathing before combat, and therapists prescribe the long exhale for panic — the handle, rediscovered wing by wing.',
        teachingText: 'The modern rediscoveries validate the map but miss the destination. Breathwork as mere performance-enhancement is pranayama with the top sawn off: in the tradition, the settled breath is not the goal but the doorway — a nervous system quiet enough that the deeper inquiries (who is breathing?) can finally be heard. Calm is the vestibule, not the temple.',
      ...
      },
      {
        ...
        storyText: 'The tradition\'s five-fold map of prana — energies of intake, elimination, circulation, ascent, and integration — reads like a maintenance manual: life-force is drawn in, moved, spent, and restored, and a day can be audited by its prana books. What genuinely restores yours — sleep, food that agrees with you, morning air, certain people? What reliably drains it — certain other people, the 1 a.m. scroll, rooms you leave tireder than you entered? The vocabulary is ancient; the audit is uncomfortably contemporary.',
        sectionHeader: 'The audit',
        teachingText: 'For one week, keep the books: two columns, restored and drained, filled honestly each evening. The tradition\'s wager is that you already know the answers and have been overruling them — and that the chief faculty, like any chief, mostly needs you to stop working against it. Guard the breath\'s hours (dawn, dusk, before sleep), spend attention like the currency it is, and the whole staff of faculties works better under a well-tended chief.',
    ...
    sections: [
      {
        ...
        storyText: 'The tradition that produced the world\'s longest texts holds a surprising position: texts are not enough. The Upanishads — the crown of the scriptures — are named not for their content but for their delivery posture: upa-ni-shad, to sit down near. Whatever these teachings are, the name insists, they pass at close range. The reason is diagnostic, not mystical: your ignorance is not general but specific — a particular knot, tied by your particular history, invisible to you precisely because you see by means of it. A book addresses everyone\'s knot. Only something that can look at you — question you, catch you, wait for you — addresses yours. Gu-ru: the remover of darkness. Not all darkness. Yours.',
        teachingText: 'This is why the tradition ranks the living teacher above the library, and why every serious craft still does: the surgeon trains under surgeons, the pianist under pianists, the meditator under meditators. Information scales; correction does not. What can be broadcast was never the bottleneck.',
      ...
      },
      {
        ...
        storyText: 'The Gita compresses the whole transmission protocol into one verse with three verbs. Pranipata — approach with humility: the bowed head is not self-abasement but an open port; nothing enters a vessel that arrives full. Pariprashna — question, repeatedly: the tradition has no use for silent nodding; the root means thorough, probing inquiry, and the entire Gita is itself one long pariprashna by Arjuna. Seva — serve: put yourself usefully near the teacher, because wisdom leaks continuously from how a knower lives, and only proximity collects it. Three verbs, and note what is absent: no fee, no enrollment, no passive consumption.',
        teachingText: 'Run the protocol on your own ambitions. For whatever you most want to learn: whom could you approach with genuine humility? What service would put you in the room where their judgment is exercised? And do you have real questions — or only the wish to have already learned? The verse is twenty-five centuries old and outperforms most modern pedagogy.',
      ...
      },
      {
        ...
        storyText: 'The Mahabharata tells it without flinching. Ekalavya, a tribal prince, asks Drona — teacher of the royal cousins — to accept him. Drona refuses; his obligations belong to the princes. Ekalavya bows, withdraws to the forest, shapes a clay image of Drona, and practices archery before it with total devotion until he surpasses every royal student. When Drona discovers this — and sees Arjuna\'s promised supremacy threatened — he does something the epic lets stand in its full ugliness: he claims the traditional teacher\'s fee, guru-dakshina, from a student he never taught. He asks for Ekalavya\'s right thumb. And Ekalavya, without hesitation, cuts it off and lays it at the feet of the man who refused him.',
        sectionHeader: 'Reading it honestly',
        teachingText: 'The story honors Ekalavya extravagantly — his devotion made a clay statue into a working guru, proof that the student\'s fire matters more than the teacher\'s presence. And it convicts Drona quietly, in the way epics convict: by consequences and by the reader\'s own recoil. The tradition keeps this story on purpose. It is the warning label on the guru principle: the channel is sacred; the humans in it can fail it; and reverence was never meant to disable your judgment. Honor teachers. Verify them too.',
      ...
      },
      {
        ...
        storyText: 'Strip the exotic costume off the word and count your actual gurus: the grandmother whose festival hands taught yours; the teacher who saw you before you were visible to yourself; the mentor whose one sentence rerouted a decade; the friend who plays Jambavan and reminds you of strength you had misfiled. The tradition\'s claim is not that you need a robed figure on a mountain — it is that the darkness-removing function is real, distributable, and already operating in your life, mostly unthanked. Guru Purnima, the summer full moon, exists precisely for the accounting: one day a year to name the chain you hang from.',
        sectionHeader: 'Both directions',
        teachingText: 'And the chain points both ways. Parampara — the unbroken succession — only stays unbroken if each link accepts both roles. Somewhere downstream of you, someone is sitting in your old darkness, and what you carry — the recipe, the prayer, the hard-won professional judgment, this very tradition you are learning — is the lamp they are waiting for. The final teaching of the guru principle is that you do not get to remain only a student. Sit near. Then be sat near.',
